...
extension Entry {
   ...
   @discardableResult convenience init(title: String, bodyText: String? = nil , timestamp: Date = Date(), identifier: String = UUID().uuidString ,mood: String = "😃", context: NSManagedObjectContext = CoreDataStack.shared.mainContext) {
