...
let baseURL = URL(string: "https://journal-blakeprice.firebaseio.com/")!
...
class EntryController {
    ...
    // MARK: - CRUD Methods
    func create(mood: String, title: String, timestamp: Date, bodyText: String?) {
        let entry = Entry(mood: mood, title: title, timestamp: timestamp, bodyText: bodyText)
        put(entry: entry)
        saveToPersistentStore()
    }
