...
class CreateEntryViewController: UIViewController {
    ...
    @IBAction func saveButtonTapped(_ sender: UIBarButtonItem) {
        ...
        let entry = Entry(title: entryTitle, timestamp: currentDate, mood: mood, identifier: UUID().uuidString, bodyText: entryDetail, context: CoreDataStack.shared.mainContext)
